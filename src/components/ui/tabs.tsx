 ...
 *
 * Extracted so the console rail can present the same set of tabs as a sidebar
 * without a second copy of the query-string handling — the two differ in what
 * they draw, not in what a tab means.
 */
export function useTabSelection(tabs: TabDefinition[], param = "tab") {
  ...
  return { visible, current, active: optimistic, select };
}

/**
 * The horizontal strip.
 *
 * Still the right shape on a phone, where a sidebar would take a third of the
 * screen before any content appeared, so the console rail falls back to this
 * below the breakpoint rather than replacing it.
 */
